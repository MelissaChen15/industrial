    ...
    def write_to_DB(self, code_sql_file_path,data_sql_file_path):
        ...
        for row in s['secucodes'].itertuples(index=True, name='Pandas'):
            try:
                ...
                pl_sql_oracle.df_to_DB(factor_values, 'seasonalfinancialqualityfactor', 'append', {'SECUCODE': String(20)})
...
if __name__ == '__main__':
    ...
    sfqf.write_to_DB(data_sql_file_path=data_sql_file_path, code_sql_file_path = code_sql_file_path)
