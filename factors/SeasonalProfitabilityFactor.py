...
class SeasonalProfitabilityFactor(SeasonalFrequency, ProfitabilityFactor):
    ...
    def find_components(self, file_path, table_name,secucode = ''):
        ...
        print(components['LC_MainIndexNew_monthly'] )
        return components
    ...
    def write_values_to_DB(self, code_sql_file_path, data_sql_file_path):
        ...
        for row in s['secucodes'].itertuples(index=True, name='Pandas'):
            try:
                ...
                # print(factor_values)
                pl_sql_oracle.df_to_DB(factor_values, 'SeasonalProfitabilityFactor'.lower(),if_exists= 'append',data_type={'SECUCODE': String(20)})
