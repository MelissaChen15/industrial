...
from mlmodels.classifiers import load_sample_data,train, predict, build_strategy,evaluate_strategy
from mlmodels.classifiers.Para import Para
para = Para()
from mlmodels.classifiers.model_inits import SVC_init, RFC_init
...
if __name__ == '__main__':
    ...
    # 2. 初始化模型
    model, model_name = RFC_init.init()
