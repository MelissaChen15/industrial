...
from Frequency import MonthlyFrequency
...
class MonthlyTurnoverFactor(MonthlyFrequency,TurnoverFactor):
    ...
    def find_components(self, file_path1,file_path2, table_name,secucode = ''):
        ...
        MonthlyTradingDay = sql.InputDataPreprocess(file_path2,['QT_TradingDayNew'],'')  # 这个secucode的''不能省去！
...
if __name__ == '__main__':
    TO = MonthlyTurnoverFactor(MonthlyFrequency, TurnoverFactor)
    data_sql_file_path = r'D:\项目\FOF相关资料\wind研报\工具性代码\Chen\industrial\factors_ver4\StockFactorsCreating\factors\sql\sql_monthly_turnover_factor.sql' # 读取数据库数据的sql代码文件路径
    weeklyday_file_path = r'D:\项目\FOF相关资料\wind研报\工具性代码\Chen\industrial\factors_ver4\StockFactorsCreating\factors\sql\sql_get_last_trading_monthday.sql'
