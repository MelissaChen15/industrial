...
from Category import VolatilityFactor
from sql import pl_sql_oracle
from util.VolatilityFuncProcess import VolatilityFuncProcess
from util.VolatilityFunc import VolatilityFunc
import pandas as pd
...
if __name__ == '__main__':
    TO = WeeklyVolatilityFactor(WeeklyFrequency, VolatilityFactor)
    data_sql_file_path = r'D:\项目\FOF相关资料\wind研报\工具性代码\Chen\industrial\factors_ver4\StockFactorsCreating\factors\sql\sql_weekly_volatility_factor.sql' # 读取数据库数据的sql代码文件路径
